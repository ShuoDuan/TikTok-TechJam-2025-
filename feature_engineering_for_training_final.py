...
def process_all_features(filename=r'C:\Users\zhang\Desktop\review-Alabama_labeled.csv'):
    try:
        # Load data
...
if __name__ == "__main__":
    ...
    if df is not None:
        ...
        output_path = r'C:\Users\zhang\Desktop\enhanced_reviews_with_features.csv'
